...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out", type=str, default="datasets/dataset_spe9.csv", help="Output CSV path")
    p.add_argument("--log", type=str, default="datasets/runs_log_spe9.csv", help="Per-sim log CSV path")
